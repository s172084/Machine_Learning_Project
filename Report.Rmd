...
Looking at the Table 2, standard deviation of *price* is some orders of magnitude larger than the 
...
Data are colored by the attribute *cut* and, for visualization purposes, only a sample of 1000 data is plotted.
...
![alt-text-1](Images/PC_Image.png "Data projected onto the first three PC-defined space")
