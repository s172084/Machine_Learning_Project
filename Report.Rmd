...
knitr::include_graphics(c('Images/DTU Logo.png'))
```
...
term: "Last compiled on `r format(Sys.time(), '%B %d, %Y')`"
output:
  pdf_document:
    keep_tex: true
...
knitr::include_graphics(c('Images/Diamond_Group.png','Images/Diamond_Group.png'))
```
\newpage
