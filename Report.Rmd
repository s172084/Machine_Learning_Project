...
The 99.99th percentile of the data set sorted by the *table* shows the following
data:
```{r}
i <- 6 # table
...
very unlikely that, considering a data set of 53940, there is a diamond with
