...
There is a positive correlation between Length(**X**) and Width(**Y**). There is a positive correlation between Width(**Y**) and Depth(**Z**).There is a positive correlation between Length(**X**) and Depth(**Z**). There is a positive correlation between carat and Length(**X**)
...
# Include images and pictures..
knitr::include_graphics('Images/hist_w_out.png')
```
...
data:
```{r}
# Can you explain this inside Code.R file? 
i <- 6 # table
...
to the the other three rows belonging to the $99.99^{th}$ percentile. It is very
...
```{r echo=FALSE, fig.align='center', out.width='60%'}
# Include images and pictures..
knitr::include_graphics('Images/hist_wo_out.png')
```
...
```{r echo=FALSE, fig.align='center', out.width='60%'}
# Include images and pictures..
knitr::include_graphics('Images/scatterplots.png')
```
...
```{r echo=FALSE, fig.ncol=2, fig.align='center', out.width='75%', include=FALSE}
# CUT, PC 1-2
Z <- S$u %*% diag(S$d)
...
# Include images and pictures..
knitr::include_graphics('Images/PC_Image.png')
```
